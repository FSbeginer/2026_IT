...
public class A_로그인 extends BF {
	...
	public A_로그인() {
		...
		label = new JLabel(getIcon("logo/logo.png", 150,150));
		label.setFont(new Font("맑은 고딕", Font.BOLD, 30));
		label.setText("iDelivery");
		label.setVerticalTextPosition(SwingConstants.BOTTOM);
		label.setHorizontalTextPosition(0);
		label.setBounds(110, 62, 217, 212);
		getContentPane().add(label);
		
		label_1 = new JLabel("ID");
		label_1.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		label_1.setBounds(41, 307, 34, 34);
		getContentPane().add(label_1);
		
		label_2 = new JLabel("PW");
		label_2.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		label_2.setBounds(41, 367, 34, 34);
		getContentPane().add(label_2);
		
		textField = new JTextField();
		textField.setBounds(97, 311, 286, 34);
		getContentPane().add(textField);
		textField.setColumns(10);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(97, 371, 286, 33);
		getContentPane().add(passwordField);
		
		button = new JButton("로그인");
		button.addActionListener(new ButtonActionListener());
		button.setFont(new Font("맑은 고딕", Font.BOLD, 12));
		button.setBounds(33, 427, 350, 34);
